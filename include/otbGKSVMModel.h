...
=========================================================================*/
#ifndef __otbGKSVMModel_h
#define __otbGKSVMModel_h
 ...
 *
 * The basic functionality of the GKSVMModel framework base class is to
...
public:
  ...
  itkNewMacro(Self);
  itkTypeMacro(GKSVMModel, itk::DataObject);
...
private:
  GKSVMModel(const Self &); //purposely not implemented
