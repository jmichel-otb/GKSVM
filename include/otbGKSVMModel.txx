...
=========================================================================*/
#ifndef __otbGKSVMModel_txx
#define __otbGKSVMModel_txx
...
GKSVMModel<TValue, TLabel>::GKSVMModel()
{
  // Default parameters
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::Initialize()
{
  // Initialize model
  if (!m_Model)
    {
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::Reset()
{
  this->DeleteProblem();
  this->DeleteModel();
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::DeleteModel()
{
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::DeleteProblem()
{
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::AddSample(const MeasurementType& measure, const LabelType& label)
{
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::ClearSamples()
{
  m_Samples.clear();
  m_ProblemUpToDate = false;
}
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::SetSamples(const SamplesVectorType& samples)
{
  m_Samples = samples;
  m_ProblemUpToDate = false;
}
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::BuildProblem()
{
...
template <class TValue, class TLabel>
double
GKSVMModel<TValue, TLabel>::CrossValidation(unsigned int nbFolders)
{
  // Build problem
  this->BuildProblem();
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::ConsistencyCheck()
{
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::Train()
{
...
template <class TValue, class TLabel>
typename GKSVMModel<TValue, TLabel>::LabelType
GKSVMModel<TValue, TLabel>::EvaluateLabel(const MeasurementType& measure) const
{
...
template <class TValue, class TLabel>
typename GKSVMModel<TValue, TLabel>::DistancesVectorType
GKSVMModel<TValue, TLabel>::EvaluateHyperplanesDistances(const MeasurementType& measure) const
{
  // Check if model is up-to-date
  if (!m_ModelUpToDate)
    {
...
template <class TValue, class TLabel>
typename GKSVMModel<TValue, TLabel>::ProbabilitiesVectorType
GKSVMModel<TValue, TLabel>::EvaluateProbabilities(const MeasurementType& measure) const
{
  // Check if model is up-to-date
  if (!m_ModelUpToDate)
    {
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::SetModel(struct svm_model* aModel)
{
  this->DeleteModel();
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::SaveModel(const char* model_file_name) const
{
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::LoadModel(const char* model_file_name)
{
  this->DeleteModel();
...
template <class TValue, class TLabel>
typename GKSVMModel<TValue, TLabel>::Pointer
GKSVMModel<TValue, TLabel>::GetCopy() const
{
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::SetSupportVectors(svm_node ** sv, int nbOfSupportVector)
{
...
template <class TValue, class TLabel>
void
GKSVMModel<TValue, TLabel>::SetAlpha(double ** alpha, int nbOfSupportVector)
{
